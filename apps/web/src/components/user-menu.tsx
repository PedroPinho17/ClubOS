...
export function UserMenu({ name, email }: UserMenuProps) {
  ...
  async function addPasskey() {
    setOpen(false);
    const res = await passkey.addPasskey({ name: displayName });
    if (res.error) {
      toast.error(res.error.message ?? "Não foi possível registar a passkey.");
      return;
    }
    toast.success("Passkey registada com sucesso");
  }
