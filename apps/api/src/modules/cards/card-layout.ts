import type { CardLayout, CardTemplateInfo } from "@clubos/shared";
...
export const CARD_CATALOG: CardTemplateInfo[] = [
  ...
  },
  {
    ...
    label: "Moderno",
    group: "base",
    description: "Modelo base com faixa de destaque e tipografia forte.",
  },
  {
    key: "minimal",
    label: "Minimal",
    group: "base",
    description: "Modelo base limpo e discreto.",
  },
  {
    key: "crc_vale",
    label: "CRC Vale (oficial)",
    group: "clube",
    description: "Layout personalizado do clube, com frente detalhada.",
  },
];
...
export function ensureTemplateAllowed(layout: CardLayout): CardLayout {
  ...
  if (!(CARD_TEMPLATES as readonly string[]).includes(layout.template)) {
    return { ...layout, template: "classic" };
  }
  return layout;
}
